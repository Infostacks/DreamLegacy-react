  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax filter image={require("assets/img/megamillions1.jpg")}>
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              <h1 className={classes.title}>Megamillions</h1>
              <br/>
            </GridItem>
          </GridContainer>
        </div>
      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
        ...
        <Card style={{background: "beige"}}>
              <CardBody>
                <h2 style={{color : "red"}}>Megamillions winning numbers</h2>
                <div>
            ...
            <Card style={{background: "beige"}}>
              <CardBody>
                    ...
                    <h5 style={{color : "black"}}>There are nine ways to win in Megamillions,
                     return to your Megamillions retailer or Lottery headquarters for validation of your tickets.</h5>
              </CardBody>
            </Card> 
        </div>
      </div>
