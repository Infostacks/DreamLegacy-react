...
export default function TeamSection() {
  ...
  useEffect(async () => {
    ...
    // console.log("hello result", poolsdata[0].data.s);
    // var states = poolsdata[0].data.s[0].i

    // for (const property in states) {
    //   console.log(`${states[property]}`);
    // }
        ...
        <GridContainer>
          <GridItem xs={12} sm={6}>
            <Card
              style={{
                background:
                  "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(214,28,102,1) 0%, rgba(59,26,136,1) 50%, rgba(228,16,92,1) 97%)",
              }}
            >
              <CardBody>
                <h2>POWERBALL</h2>
                ...
                <h5 style={{ color: "white", background: "black" }}>
                  $202,000,000
                </h5>
                <div>
                  <GridContainer>
